...
public interface RepoMapper extends BaseMapper<Repo> {
     ...
     * @return 结果集
     */
    List<RepoListVO> selectRepoList(@Param("repoTitle") String repoTitle, @Param("userId") int userId);
     ...
     * @return 分页结果
     */
    Page<Repo> selectUserExerciseRecord(Page<Repo> repoPage, @Param("userId") Integer userId, @Param("repoName") String repoName);
