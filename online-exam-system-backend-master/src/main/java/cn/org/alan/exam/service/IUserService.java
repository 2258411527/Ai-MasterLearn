...
public interface IUserService extends IService<User> {
     ...
     * @return
     */
    Result<String> adminJoinGrade(String code);
     ...
     * @return
     */
    Result<IPage<UserVO>> pagingUser(Integer pageNum, Integer pageSize, Integer gradeId, String realName, Integer auditStatus);
