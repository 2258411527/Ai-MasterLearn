...
public class GradeController {
    ...
    @ApiOperation("教师移除学生出班级")
    @DeleteMapping("/teacher/remove-student/{studentId}")
    @PreAuthorize("hasAnyAuthority('role_teacher')")
    public Result<String> teacherRemoveStudent(@PathVariable("studentId") @NotNull Integer studentId) {
        return gradeService.teacherRemoveStudent(studentId);
    }
}